...
def write_result():
    with open(DATA_DIR + "mem.csv", "w") as mem_csv:
        ...
        print("")
        print("en_rss_geomean: " + str(en_rss_geomean))
        print("en_wss_geomean: " + str(en_wss_geomean))
        print("de_rss_geomean: " + str(de_rss_geomean))
        print("de_wss_geomean: " + str(de_wss_geomean))
